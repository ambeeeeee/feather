...
impl Item {
    ...
    /// Gets a `Item` by its `display_name`.
    pub fn from_display_name(display_name: &str) -> Option<Self> {
        match display_name {
            "Air" => Some(Item::Air),
            "Stone" => Some(Item::Stone),
            "Granite" => Some(Item::Granite),
            "Polished Granite" => Some(Item::PolishedGranite),
            "Diorite" => Some(Item::Diorite),
            "Polished Diorite" => Some(Item::PolishedDiorite),
            "Andesite" => Some(Item::Andesite),
            "Polished Andesite" => Some(Item::PolishedAndesite),
            "Grass Block" => Some(Item::GrassBlock),
            "Dirt" => Some(Item::Dirt),
            "Coarse Dirt" => Some(Item::CoarseDirt),
            "Podzol" => Some(Item::Podzol),
            "Crimson Nylium" => Some(Item::CrimsonNylium),
            "Warped Nylium" => Some(Item::WarpedNylium),
            "Cobblestone" => Some(Item::Cobblestone),
            "Oak Planks" => Some(Item::OakPlanks),
            "Spruce Planks" => Some(Item::SprucePlanks),
            "Birch Planks" => Some(Item::BirchPlanks),
            "Jungle Planks" => Some(Item::JunglePlanks),
            "Acacia Planks" => Some(Item::AcaciaPlanks),
            "Dark Oak Planks" => Some(Item::DarkOakPlanks),
            "Crimson Planks" => Some(Item::CrimsonPlanks),
            "Warped Planks" => Some(Item::WarpedPlanks),
            "Oak Sapling" => Some(Item::OakSapling),
            "Spruce Sapling" => Some(Item::SpruceSapling),
            "Birch Sapling" => Some(Item::BirchSapling),
            "Jungle Sapling" => Some(Item::JungleSapling),
            "Acacia Sapling" => Some(Item::AcaciaSapling),
            "Dark Oak Sapling" => Some(Item::DarkOakSapling),
            "Bedrock" => Some(Item::Bedrock),
            "Sand" => Some(Item::Sand),
            "Red Sand" => Some(Item::RedSand),
            "Gravel" => Some(Item::Gravel),
            "Gold Ore" => Some(Item::GoldOre),
            "Iron Ore" => Some(Item::IronOre),
            "Coal Ore" => Some(Item::CoalOre),
            "Nether Gold Ore" => Some(Item::NetherGoldOre),
            "Oak Log" => Some(Item::OakLog),
            "Spruce Log" => Some(Item::SpruceLog),
            "Birch Log" => Some(Item::BirchLog),
            "Jungle Log" => Some(Item::JungleLog),
            "Acacia Log" => Some(Item::AcaciaLog),
            "Dark Oak Log" => Some(Item::DarkOakLog),
            "Crimson Stem" => Some(Item::CrimsonStem),
            "Warped Stem" => Some(Item::WarpedStem),
            "Stripped Oak Log" => Some(Item::StrippedOakLog),
            "Stripped Spruce Log" => Some(Item::StrippedSpruceLog),
            "Stripped Birch Log" => Some(Item::StrippedBirchLog),
            "Stripped Jungle Log" => Some(Item::StrippedJungleLog),
            "Stripped Acacia Log" => Some(Item::StrippedAcaciaLog),
            "Stripped Dark Oak Log" => Some(Item::StrippedDarkOakLog),
            "Stripped Crimson Stem" => Some(Item::StrippedCrimsonStem),
            "Stripped Warped Stem" => Some(Item::StrippedWarpedStem),
            "Stripped Oak Wood" => Some(Item::StrippedOakWood),
            "Stripped Spruce Wood" => Some(Item::StrippedSpruceWood),
            "Stripped Birch Wood" => Some(Item::StrippedBirchWood),
            "Stripped Jungle Wood" => Some(Item::StrippedJungleWood),
            "Stripped Acacia Wood" => Some(Item::StrippedAcaciaWood),
            "Stripped Dark Oak Wood" => Some(Item::StrippedDarkOakWood),
            "Stripped Crimson Hyphae" => Some(Item::StrippedCrimsonHyphae),
            "Stripped Warped Hyphae" => Some(Item::StrippedWarpedHyphae),
            "Oak Wood" => Some(Item::OakWood),
            "Spruce Wood" => Some(Item::SpruceWood),
            "Birch Wood" => Some(Item::BirchWood),
            "Jungle Wood" => Some(Item::JungleWood),
            "Acacia Wood" => Some(Item::AcaciaWood),
            "Dark Oak Wood" => Some(Item::DarkOakWood),
            "Crimson Hyphae" => Some(Item::CrimsonHyphae),
            "Warped Hyphae" => Some(Item::WarpedHyphae),
            "Oak Leaves" => Some(Item::OakLeaves),
            "Spruce Leaves" => Some(Item::SpruceLeaves),
            "Birch Leaves" => Some(Item::BirchLeaves),
            "Jungle Leaves" => Some(Item::JungleLeaves),
            "Acacia Leaves" => Some(Item::AcaciaLeaves),
            "Dark Oak Leaves" => Some(Item::DarkOakLeaves),
            "Sponge" => Some(Item::Sponge),
            "Wet Sponge" => Some(Item::WetSponge),
            "Glass" => Some(Item::Glass),
            "Lapis Lazuli Ore" => Some(Item::LapisOre),
            "Lapis Lazuli Block" => Some(Item::LapisBlock),
            "Dispenser" => Some(Item::Dispenser),
            "Sandstone" => Some(Item::Sandstone),
            "Chiseled Sandstone" => Some(Item::ChiseledSandstone),
            "Cut Sandstone" => Some(Item::CutSandstone),
            "Note Block" => Some(Item::NoteBlock),
            "Powered Rail" => Some(Item::PoweredRail),
            "Detector Rail" => Some(Item::DetectorRail),
            "Sticky Piston" => Some(Item::StickyPiston),
            "Cobweb" => Some(Item::Cobweb),
            "Grass" => Some(Item::Grass),
            "Fern" => Some(Item::Fern),
            "Dead Bush" => Some(Item::DeadBush),
            "Seagrass" => Some(Item::Seagrass),
            "Sea Pickle" => Some(Item::SeaPickle),
            "Piston" => Some(Item::Piston),
            "White Wool" => Some(Item::WhiteWool),
            "Orange Wool" => Some(Item::OrangeWool),
            "Magenta Wool" => Some(Item::MagentaWool),
            "Light Blue Wool" => Some(Item::LightBlueWool),
            "Yellow Wool" => Some(Item::YellowWool),
            "Lime Wool" => Some(Item::LimeWool),
            "Pink Wool" => Some(Item::PinkWool),
            "Gray Wool" => Some(Item::GrayWool),
            "Light Gray Wool" => Some(Item::LightGrayWool),
            "Cyan Wool" => Some(Item::CyanWool),
            "Purple Wool" => Some(Item::PurpleWool),
            "Blue Wool" => Some(Item::BlueWool),
            "Brown Wool" => Some(Item::BrownWool),
            "Green Wool" => Some(Item::GreenWool),
            "Red Wool" => Some(Item::RedWool),
            "Black Wool" => Some(Item::BlackWool),
            "Dandelion" => Some(Item::Dandelion),
            "Poppy" => Some(Item::Poppy),
            "Blue Orchid" => Some(Item::BlueOrchid),
            "Allium" => Some(Item::Allium),
            "Azure Bluet" => Some(Item::AzureBluet),
            "Red Tulip" => Some(Item::RedTulip),
            "Orange Tulip" => Some(Item::OrangeTulip),
            "White Tulip" => Some(Item::WhiteTulip),
            "Pink Tulip" => Some(Item::PinkTulip),
            "Oxeye Daisy" => Some(Item::OxeyeDaisy),
            "Cornflower" => Some(Item::Cornflower),
            "Lily of the Valley" => Some(Item::LilyOfTheValley),
            "Wither Rose" => Some(Item::WitherRose),
            "Brown Mushroom" => Some(Item::BrownMushroom),
            "Red Mushroom" => Some(Item::RedMushroom),
            "Crimson Fungus" => Some(Item::CrimsonFungus),
            "Warped Fungus" => Some(Item::WarpedFungus),
            "Crimson Roots" => Some(Item::CrimsonRoots),
            "Warped Roots" => Some(Item::WarpedRoots),
            "Nether Sprouts" => Some(Item::NetherSprouts),
            "Weeping Vines" => Some(Item::WeepingVines),
            "Twisting Vines" => Some(Item::TwistingVines),
            "Sugar Cane" => Some(Item::SugarCane),
            "Kelp" => Some(Item::Kelp),
            "Bamboo" => Some(Item::Bamboo),
            "Block of Gold" => Some(Item::GoldBlock),
            "Block of Iron" => Some(Item::IronBlock),
            "Oak Slab" => Some(Item::OakSlab),
            "Spruce Slab" => Some(Item::SpruceSlab),
            "Birch Slab" => Some(Item::BirchSlab),
            "Jungle Slab" => Some(Item::JungleSlab),
            "Acacia Slab" => Some(Item::AcaciaSlab),
            "Dark Oak Slab" => Some(Item::DarkOakSlab),
            "Crimson Slab" => Some(Item::CrimsonSlab),
            "Warped Slab" => Some(Item::WarpedSlab),
            "Stone Slab" => Some(Item::StoneSlab),
            "Smooth Stone Slab" => Some(Item::SmoothStoneSlab),
            "Sandstone Slab" => Some(Item::SandstoneSlab),
            "Cut Sandstone Slab" => Some(Item::CutSandstoneSlab),
            "Petrified Oak Slab" => Some(Item::PetrifiedOakSlab),
            "Cobblestone Slab" => Some(Item::CobblestoneSlab),
            "Brick Slab" => Some(Item::BrickSlab),
            "Stone Brick Slab" => Some(Item::StoneBrickSlab),
            "Nether Brick Slab" => Some(Item::NetherBrickSlab),
            "Quartz Slab" => Some(Item::QuartzSlab),
            "Red Sandstone Slab" => Some(Item::RedSandstoneSlab),
            "Cut Red Sandstone Slab" => Some(Item::CutRedSandstoneSlab),
            "Purpur Slab" => Some(Item::PurpurSlab),
            "Prismarine Slab" => Some(Item::PrismarineSlab),
            "Prismarine Brick Slab" => Some(Item::PrismarineBrickSlab),
            "Dark Prismarine Slab" => Some(Item::DarkPrismarineSlab),
            "Smooth Quartz Block" => Some(Item::SmoothQuartz),
            "Smooth Red Sandstone" => Some(Item::SmoothRedSandstone),
            "Smooth Sandstone" => Some(Item::SmoothSandstone),
            "Smooth Stone" => Some(Item::SmoothStone),
            "Bricks" => Some(Item::Bricks),
            "TNT" => Some(Item::Tnt),
            "Bookshelf" => Some(Item::Bookshelf),
            "Mossy Cobblestone" => Some(Item::MossyCobblestone),
            "Obsidian" => Some(Item::Obsidian),
            "Torch" => Some(Item::Torch),
            "End Rod" => Some(Item::EndRod),
            "Chorus Plant" => Some(Item::ChorusPlant),
            "Chorus Flower" => Some(Item::ChorusFlower),
            "Purpur Block" => Some(Item::PurpurBlock),
            "Purpur Pillar" => Some(Item::PurpurPillar),
            "Purpur Stairs" => Some(Item::PurpurStairs),
            "Spawner" => Some(Item::Spawner),
            "Oak Stairs" => Some(Item::OakStairs),
            "Chest" => Some(Item::Chest),
            "Diamond Ore" => Some(Item::DiamondOre),
            "Block of Diamond" => Some(Item::DiamondBlock),
            "Crafting Table" => Some(Item::CraftingTable),
            "Farmland" => Some(Item::Farmland),
            "Furnace" => Some(Item::Furnace),
            "Ladder" => Some(Item::Ladder),
            "Rail" => Some(Item::Rail),
            "Cobblestone Stairs" => Some(Item::CobblestoneStairs),
            "Lever" => Some(Item::Lever),
            "Stone Pressure Plate" => Some(Item::StonePressurePlate),
            "Oak Pressure Plate" => Some(Item::OakPressurePlate),
            "Spruce Pressure Plate" => Some(Item::SprucePressurePlate),
            "Birch Pressure Plate" => Some(Item::BirchPressurePlate),
            "Jungle Pressure Plate" => Some(Item::JunglePressurePlate),
            "Acacia Pressure Plate" => Some(Item::AcaciaPressurePlate),
            "Dark Oak Pressure Plate" => Some(Item::DarkOakPressurePlate),
            "Crimson Pressure Plate" => Some(Item::CrimsonPressurePlate),
            "Warped Pressure Plate" => Some(Item::WarpedPressurePlate),
            "Polished Blackstone Pressure Plate" => Some(Item::PolishedBlackstonePressurePlate),
            "Redstone Ore" => Some(Item::RedstoneOre),
            "Redstone Torch" => Some(Item::RedstoneTorch),
            "Snow" => Some(Item::Snow),
            "Ice" => Some(Item::Ice),
            "Snow Block" => Some(Item::SnowBlock),
            "Cactus" => Some(Item::Cactus),
            "Clay" => Some(Item::Clay),
            "Jukebox" => Some(Item::Jukebox),
            "Oak Fence" => Some(Item::OakFence),
            "Spruce Fence" => Some(Item::SpruceFence),
            "Birch Fence" => Some(Item::BirchFence),
            "Jungle Fence" => Some(Item::JungleFence),
            "Acacia Fence" => Some(Item::AcaciaFence),
            "Dark Oak Fence" => Some(Item::DarkOakFence),
            "Crimson Fence" => Some(Item::CrimsonFence),
            "Warped Fence" => Some(Item::WarpedFence),
            "Pumpkin" => Some(Item::Pumpkin),
            "Carved Pumpkin" => Some(Item::CarvedPumpkin),
            "Netherrack" => Some(Item::Netherrack),
            "Soul Sand" => Some(Item::SoulSand),
            "Soul Soil" => Some(Item::SoulSoil),
            "Basalt" => Some(Item::Basalt),
            "Polished Basalt" => Some(Item::PolishedBasalt),
            "Soul Torch" => Some(Item::SoulTorch),
            "Glowstone" => Some(Item::Glowstone),
            "Jack o'Lantern" => Some(Item::JackOLantern),
            "Oak Trapdoor" => Some(Item::OakTrapdoor),
            "Spruce Trapdoor" => Some(Item::SpruceTrapdoor),
            "Birch Trapdoor" => Some(Item::BirchTrapdoor),
            "Jungle Trapdoor" => Some(Item::JungleTrapdoor),
            "Acacia Trapdoor" => Some(Item::AcaciaTrapdoor),
            "Dark Oak Trapdoor" => Some(Item::DarkOakTrapdoor),
            "Crimson Trapdoor" => Some(Item::CrimsonTrapdoor),
            "Warped Trapdoor" => Some(Item::WarpedTrapdoor),
            "Infested Stone" => Some(Item::InfestedStone),
            "Infested Cobblestone" => Some(Item::InfestedCobblestone),
            "Infested Stone Bricks" => Some(Item::InfestedStoneBricks),
            "Infested Mossy Stone Bricks" => Some(Item::InfestedMossyStoneBricks),
            "Infested Cracked Stone Bricks" => Some(Item::InfestedCrackedStoneBricks),
            "Infested Chiseled Stone Bricks" => Some(Item::InfestedChiseledStoneBricks),
            "Stone Bricks" => Some(Item::StoneBricks),
            "Mossy Stone Bricks" => Some(Item::MossyStoneBricks),
            "Cracked Stone Bricks" => Some(Item::CrackedStoneBricks),
            "Chiseled Stone Bricks" => Some(Item::ChiseledStoneBricks),
            "Brown Mushroom Block" => Some(Item::BrownMushroomBlock),
            "Red Mushroom Block" => Some(Item::RedMushroomBlock),
            "Mushroom Stem" => Some(Item::MushroomStem),
            "Iron Bars" => Some(Item::IronBars),
            "Chain" => Some(Item::Chain),
            "Glass Pane" => Some(Item::GlassPane),
            "Melon" => Some(Item::Melon),
            "Vines" => Some(Item::Vine),
            "Oak Fence Gate" => Some(Item::OakFenceGate),
            "Spruce Fence Gate" => Some(Item::SpruceFenceGate),
            "Birch Fence Gate" => Some(Item::BirchFenceGate),
            "Jungle Fence Gate" => Some(Item::JungleFenceGate),
            "Acacia Fence Gate" => Some(Item::AcaciaFenceGate),
            "Dark Oak Fence Gate" => Some(Item::DarkOakFenceGate),
            "Crimson Fence Gate" => Some(Item::CrimsonFenceGate),
            "Warped Fence Gate" => Some(Item::WarpedFenceGate),
            "Brick Stairs" => Some(Item::BrickStairs),
            "Stone Brick Stairs" => Some(Item::StoneBrickStairs),
            "Mycelium" => Some(Item::Mycelium),
            "Lily Pad" => Some(Item::LilyPad),
            "Nether Bricks" => Some(Item::NetherBricks),
            "Cracked Nether Bricks" => Some(Item::CrackedNetherBricks),
            "Chiseled Nether Bricks" => Some(Item::ChiseledNetherBricks),
            "Nether Brick Fence" => Some(Item::NetherBrickFence),
            "Nether Brick Stairs" => Some(Item::NetherBrickStairs),
            "Enchanting Table" => Some(Item::EnchantingTable),
            "End Portal Frame" => Some(Item::EndPortalFrame),
            "End Stone" => Some(Item::EndStone),
            "End Stone Bricks" => Some(Item::EndStoneBricks),
            "Dragon Egg" => Some(Item::DragonEgg),
            "Redstone Lamp" => Some(Item::RedstoneLamp),
            "Sandstone Stairs" => Some(Item::SandstoneStairs),
            "Emerald Ore" => Some(Item::EmeraldOre),
            "Ender Chest" => Some(Item::EnderChest),
            "Tripwire Hook" => Some(Item::TripwireHook),
            "Block of Emerald" => Some(Item::EmeraldBlock),
            "Spruce Stairs" => Some(Item::SpruceStairs),
            "Birch Stairs" => Some(Item::BirchStairs),
            "Jungle Stairs" => Some(Item::JungleStairs),
            "Crimson Stairs" => Some(Item::CrimsonStairs),
            "Warped Stairs" => Some(Item::WarpedStairs),
            "Command Block" => Some(Item::CommandBlock),
            "Beacon" => Some(Item::Beacon),
            "Cobblestone Wall" => Some(Item::CobblestoneWall),
            "Mossy Cobblestone Wall" => Some(Item::MossyCobblestoneWall),
            "Brick Wall" => Some(Item::BrickWall),
            "Prismarine Wall" => Some(Item::PrismarineWall),
            "Red Sandstone Wall" => Some(Item::RedSandstoneWall),
            "Mossy Stone Brick Wall" => Some(Item::MossyStoneBrickWall),
            "Granite Wall" => Some(Item::GraniteWall),
            "Stone Brick Wall" => Some(Item::StoneBrickWall),
            "Nether Brick Wall" => Some(Item::NetherBrickWall),
            "Andesite Wall" => Some(Item::AndesiteWall),
            "Red Nether Brick Wall" => Some(Item::RedNetherBrickWall),
            "Sandstone Wall" => Some(Item::SandstoneWall),
            "End Stone Brick Wall" => Some(Item::EndStoneBrickWall),
            "Diorite Wall" => Some(Item::DioriteWall),
            "Blackstone Wall" => Some(Item::BlackstoneWall),
            "Polished Blackstone Wall" => Some(Item::PolishedBlackstoneWall),
            "Polished Blackstone Brick Wall" => Some(Item::PolishedBlackstoneBrickWall),
            "Stone Button" => Some(Item::StoneButton),
            "Oak Button" => Some(Item::OakButton),
            "Spruce Button" => Some(Item::SpruceButton),
            "Birch Button" => Some(Item::BirchButton),
            "Jungle Button" => Some(Item::JungleButton),
            "Acacia Button" => Some(Item::AcaciaButton),
            "Dark Oak Button" => Some(Item::DarkOakButton),
            "Crimson Button" => Some(Item::CrimsonButton),
            "Warped Button" => Some(Item::WarpedButton),
            "Polished Blackstone Button" => Some(Item::PolishedBlackstoneButton),
            "Anvil" => Some(Item::Anvil),
            "Chipped Anvil" => Some(Item::ChippedAnvil),
            "Damaged Anvil" => Some(Item::DamagedAnvil),
            "Trapped Chest" => Some(Item::TrappedChest),
            "Light Weighted Pressure Plate" => Some(Item::LightWeightedPressurePlate),
            "Heavy Weighted Pressure Plate" => Some(Item::HeavyWeightedPressurePlate),
            "Daylight Detector" => Some(Item::DaylightDetector),
            "Block of Redstone" => Some(Item::RedstoneBlock),
            "Nether Quartz Ore" => Some(Item::NetherQuartzOre),
            "Hopper" => Some(Item::Hopper),
            "Chiseled Quartz Block" => Some(Item::ChiseledQuartzBlock),
            "Block of Quartz" => Some(Item::QuartzBlock),
            "Quartz Bricks" => Some(Item::QuartzBricks),
            "Quartz Pillar" => Some(Item::QuartzPillar),
            "Quartz Stairs" => Some(Item::QuartzStairs),
            "Activator Rail" => Some(Item::ActivatorRail),
            "Dropper" => Some(Item::Dropper),
            "White Terracotta" => Some(Item::WhiteTerracotta),
            "Orange Terracotta" => Some(Item::OrangeTerracotta),
            "Magenta Terracotta" => Some(Item::MagentaTerracotta),
            "Light Blue Terracotta" => Some(Item::LightBlueTerracotta),
            "Yellow Terracotta" => Some(Item::YellowTerracotta),
            "Lime Terracotta" => Some(Item::LimeTerracotta),
            "Pink Terracotta" => Some(Item::PinkTerracotta),
            "Gray Terracotta" => Some(Item::GrayTerracotta),
            "Light Gray Terracotta" => Some(Item::LightGrayTerracotta),
            "Cyan Terracotta" => Some(Item::CyanTerracotta),
            "Purple Terracotta" => Some(Item::PurpleTerracotta),
            "Blue Terracotta" => Some(Item::BlueTerracotta),
            "Brown Terracotta" => Some(Item::BrownTerracotta),
            "Green Terracotta" => Some(Item::GreenTerracotta),
            "Red Terracotta" => Some(Item::RedTerracotta),
            "Black Terracotta" => Some(Item::BlackTerracotta),
            "Barrier" => Some(Item::Barrier),
            "Iron Trapdoor" => Some(Item::IronTrapdoor),
            "Hay Bale" => Some(Item::HayBlock),
            "White Carpet" => Some(Item::WhiteCarpet),
            "Orange Carpet" => Some(Item::OrangeCarpet),
            "Magenta Carpet" => Some(Item::MagentaCarpet),
            "Light Blue Carpet" => Some(Item::LightBlueCarpet),
            "Yellow Carpet" => Some(Item::YellowCarpet),
            "Lime Carpet" => Some(Item::LimeCarpet),
            "Pink Carpet" => Some(Item::PinkCarpet),
            "Gray Carpet" => Some(Item::GrayCarpet),
            "Light Gray Carpet" => Some(Item::LightGrayCarpet),
            "Cyan Carpet" => Some(Item::CyanCarpet),
            "Purple Carpet" => Some(Item::PurpleCarpet),
            "Blue Carpet" => Some(Item::BlueCarpet),
            "Brown Carpet" => Some(Item::BrownCarpet),
            "Green Carpet" => Some(Item::GreenCarpet),
            "Red Carpet" => Some(Item::RedCarpet),
            "Black Carpet" => Some(Item::BlackCarpet),
            "Terracotta" => Some(Item::Terracotta),
            "Block of Coal" => Some(Item::CoalBlock),
            "Packed Ice" => Some(Item::PackedIce),
            "Acacia Stairs" => Some(Item::AcaciaStairs),
            "Dark Oak Stairs" => Some(Item::DarkOakStairs),
            "Slime Block" => Some(Item::SlimeBlock),
            "Grass Path" => Some(Item::GrassPath),
            "Sunflower" => Some(Item::Sunflower),
            "Lilac" => Some(Item::Lilac),
            "Rose Bush" => Some(Item::RoseBush),
            "Peony" => Some(Item::Peony),
            "Tall Grass" => Some(Item::TallGrass),
            "Large Fern" => Some(Item::LargeFern),
            "White Stained Glass" => Some(Item::WhiteStainedGlass),
            "Orange Stained Glass" => Some(Item::OrangeStainedGlass),
            "Magenta Stained Glass" => Some(Item::MagentaStainedGlass),
            "Light Blue Stained Glass" => Some(Item::LightBlueStainedGlass),
            "Yellow Stained Glass" => Some(Item::YellowStainedGlass),
            "Lime Stained Glass" => Some(Item::LimeStainedGlass),
            "Pink Stained Glass" => Some(Item::PinkStainedGlass),
            "Gray Stained Glass" => Some(Item::GrayStainedGlass),
            "Light Gray Stained Glass" => Some(Item::LightGrayStainedGlass),
            "Cyan Stained Glass" => Some(Item::CyanStainedGlass),
            "Purple Stained Glass" => Some(Item::PurpleStainedGlass),
            "Blue Stained Glass" => Some(Item::BlueStainedGlass),
            "Brown Stained Glass" => Some(Item::BrownStainedGlass),
            "Green Stained Glass" => Some(Item::GreenStainedGlass),
            "Red Stained Glass" => Some(Item::RedStainedGlass),
            "Black Stained Glass" => Some(Item::BlackStainedGlass),
            "White Stained Glass Pane" => Some(Item::WhiteStainedGlassPane),
            "Orange Stained Glass Pane" => Some(Item::OrangeStainedGlassPane),
            "Magenta Stained Glass Pane" => Some(Item::MagentaStainedGlassPane),
            "Light Blue Stained Glass Pane" => Some(Item::LightBlueStainedGlassPane),
            "Yellow Stained Glass Pane" => Some(Item::YellowStainedGlassPane),
            "Lime Stained Glass Pane" => Some(Item::LimeStainedGlassPane),
            "Pink Stained Glass Pane" => Some(Item::PinkStainedGlassPane),
            "Gray Stained Glass Pane" => Some(Item::GrayStainedGlassPane),
            "Light Gray Stained Glass Pane" => Some(Item::LightGrayStainedGlassPane),
            "Cyan Stained Glass Pane" => Some(Item::CyanStainedGlassPane),
            "Purple Stained Glass Pane" => Some(Item::PurpleStainedGlassPane),
            "Blue Stained Glass Pane" => Some(Item::BlueStainedGlassPane),
            "Brown Stained Glass Pane" => Some(Item::BrownStainedGlassPane),
            "Green Stained Glass Pane" => Some(Item::GreenStainedGlassPane),
            "Red Stained Glass Pane" => Some(Item::RedStainedGlassPane),
            "Black Stained Glass Pane" => Some(Item::BlackStainedGlassPane),
            "Prismarine" => Some(Item::Prismarine),
            "Prismarine Bricks" => Some(Item::PrismarineBricks),
            "Dark Prismarine" => Some(Item::DarkPrismarine),
            "Prismarine Stairs" => Some(Item::PrismarineStairs),
            "Prismarine Brick Stairs" => Some(Item::PrismarineBrickStairs),
            "Dark Prismarine Stairs" => Some(Item::DarkPrismarineStairs),
            "Sea Lantern" => Some(Item::SeaLantern),
            "Red Sandstone" => Some(Item::RedSandstone),
            "Chiseled Red Sandstone" => Some(Item::ChiseledRedSandstone),
            "Cut Red Sandstone" => Some(Item::CutRedSandstone),
            "Red Sandstone Stairs" => Some(Item::RedSandstoneStairs),
            "Repeating Command Block" => Some(Item::RepeatingCommandBlock),
            "Chain Command Block" => Some(Item::ChainCommandBlock),
            "Magma Block" => Some(Item::MagmaBlock),
            "Nether Wart Block" => Some(Item::NetherWartBlock),
            "Warped Wart Block" => Some(Item::WarpedWartBlock),
            "Red Nether Bricks" => Some(Item::RedNetherBricks),
            "Bone Block" => Some(Item::BoneBlock),
            "Structure Void" => Some(Item::StructureVoid),
            "Observer" => Some(Item::Observer),
            "Shulker Box" => Some(Item::ShulkerBox),
            "White Shulker Box" => Some(Item::WhiteShulkerBox),
            "Orange Shulker Box" => Some(Item::OrangeShulkerBox),
            "Magenta Shulker Box" => Some(Item::MagentaShulkerBox),
            "Light Blue Shulker Box" => Some(Item::LightBlueShulkerBox),
            "Yellow Shulker Box" => Some(Item::YellowShulkerBox),
            "Lime Shulker Box" => Some(Item::LimeShulkerBox),
            "Pink Shulker Box" => Some(Item::PinkShulkerBox),
            "Gray Shulker Box" => Some(Item::GrayShulkerBox),
            "Light Gray Shulker Box" => Some(Item::LightGrayShulkerBox),
            "Cyan Shulker Box" => Some(Item::CyanShulkerBox),
            "Purple Shulker Box" => Some(Item::PurpleShulkerBox),
            "Blue Shulker Box" => Some(Item::BlueShulkerBox),
            "Brown Shulker Box" => Some(Item::BrownShulkerBox),
            "Green Shulker Box" => Some(Item::GreenShulkerBox),
            "Red Shulker Box" => Some(Item::RedShulkerBox),
            "Black Shulker Box" => Some(Item::BlackShulkerBox),
            "White Glazed Terracotta" => Some(Item::WhiteGlazedTerracotta),
            "Orange Glazed Terracotta" => Some(Item::OrangeGlazedTerracotta),
            "Magenta Glazed Terracotta" => Some(Item::MagentaGlazedTerracotta),
            "Light Blue Glazed Terracotta" => Some(Item::LightBlueGlazedTerracotta),
            "Yellow Glazed Terracotta" => Some(Item::YellowGlazedTerracotta),
            "Lime Glazed Terracotta" => Some(Item::LimeGlazedTerracotta),
            "Pink Glazed Terracotta" => Some(Item::PinkGlazedTerracotta),
            "Gray Glazed Terracotta" => Some(Item::GrayGlazedTerracotta),
            "Light Gray Glazed Terracotta" => Some(Item::LightGrayGlazedTerracotta),
            "Cyan Glazed Terracotta" => Some(Item::CyanGlazedTerracotta),
            "Purple Glazed Terracotta" => Some(Item::PurpleGlazedTerracotta),
            "Blue Glazed Terracotta" => Some(Item::BlueGlazedTerracotta),
            "Brown Glazed Terracotta" => Some(Item::BrownGlazedTerracotta),
            "Green Glazed Terracotta" => Some(Item::GreenGlazedTerracotta),
            "Red Glazed Terracotta" => Some(Item::RedGlazedTerracotta),
            "Black Glazed Terracotta" => Some(Item::BlackGlazedTerracotta),
            "White Concrete" => Some(Item::WhiteConcrete),
            "Orange Concrete" => Some(Item::OrangeConcrete),
            "Magenta Concrete" => Some(Item::MagentaConcrete),
            "Light Blue Concrete" => Some(Item::LightBlueConcrete),
            "Yellow Concrete" => Some(Item::YellowConcrete),
            "Lime Concrete" => Some(Item::LimeConcrete),
            "Pink Concrete" => Some(Item::PinkConcrete),
            "Gray Concrete" => Some(Item::GrayConcrete),
            "Light Gray Concrete" => Some(Item::LightGrayConcrete),
            "Cyan Concrete" => Some(Item::CyanConcrete),
            "Purple Concrete" => Some(Item::PurpleConcrete),
            "Blue Concrete" => Some(Item::BlueConcrete),
            "Brown Concrete" => Some(Item::BrownConcrete),
            "Green Concrete" => Some(Item::GreenConcrete),
            "Red Concrete" => Some(Item::RedConcrete),
            "Black Concrete" => Some(Item::BlackConcrete),
            "White Concrete Powder" => Some(Item::WhiteConcretePowder),
            "Orange Concrete Powder" => Some(Item::OrangeConcretePowder),
            "Magenta Concrete Powder" => Some(Item::MagentaConcretePowder),
            "Light Blue Concrete Powder" => Some(Item::LightBlueConcretePowder),
            "Yellow Concrete Powder" => Some(Item::YellowConcretePowder),
            "Lime Concrete Powder" => Some(Item::LimeConcretePowder),
            "Pink Concrete Powder" => Some(Item::PinkConcretePowder),
            "Gray Concrete Powder" => Some(Item::GrayConcretePowder),
            "Light Gray Concrete Powder" => Some(Item::LightGrayConcretePowder),
            "Cyan Concrete Powder" => Some(Item::CyanConcretePowder),
            "Purple Concrete Powder" => Some(Item::PurpleConcretePowder),
            "Blue Concrete Powder" => Some(Item::BlueConcretePowder),
            "Brown Concrete Powder" => Some(Item::BrownConcretePowder),
            "Green Concrete Powder" => Some(Item::GreenConcretePowder),
            "Red Concrete Powder" => Some(Item::RedConcretePowder),
            "Black Concrete Powder" => Some(Item::BlackConcretePowder),
            "Turtle Egg" => Some(Item::TurtleEgg),
            "Dead Tube Coral Block" => Some(Item::DeadTubeCoralBlock),
            "Dead Brain Coral Block" => Some(Item::DeadBrainCoralBlock),
            "Dead Bubble Coral Block" => Some(Item::DeadBubbleCoralBlock),
            "Dead Fire Coral Block" => Some(Item::DeadFireCoralBlock),
            "Dead Horn Coral Block" => Some(Item::DeadHornCoralBlock),
            "Tube Coral Block" => Some(Item::TubeCoralBlock),
            "Brain Coral Block" => Some(Item::BrainCoralBlock),
            "Bubble Coral Block" => Some(Item::BubbleCoralBlock),
            "Fire Coral Block" => Some(Item::FireCoralBlock),
            "Horn Coral Block" => Some(Item::HornCoralBlock),
            "Tube Coral" => Some(Item::TubeCoral),
            "Brain Coral" => Some(Item::BrainCoral),
            "Bubble Coral" => Some(Item::BubbleCoral),
            "Fire Coral" => Some(Item::FireCoral),
            "Horn Coral" => Some(Item::HornCoral),
            "Dead Brain Coral" => Some(Item::DeadBrainCoral),
            "Dead Bubble Coral" => Some(Item::DeadBubbleCoral),
            "Dead Fire Coral" => Some(Item::DeadFireCoral),
            "Dead Horn Coral" => Some(Item::DeadHornCoral),
            "Dead Tube Coral" => Some(Item::DeadTubeCoral),
            "Tube Coral Fan" => Some(Item::TubeCoralFan),
            "Brain Coral Fan" => Some(Item::BrainCoralFan),
            "Bubble Coral Fan" => Some(Item::BubbleCoralFan),
            "Fire Coral Fan" => Some(Item::FireCoralFan),
            "Horn Coral Fan" => Some(Item::HornCoralFan),
            "Dead Tube Coral Fan" => Some(Item::DeadTubeCoralFan),
            "Dead Brain Coral Fan" => Some(Item::DeadBrainCoralFan),
            "Dead Bubble Coral Fan" => Some(Item::DeadBubbleCoralFan),
            "Dead Fire Coral Fan" => Some(Item::DeadFireCoralFan),
            "Dead Horn Coral Fan" => Some(Item::DeadHornCoralFan),
            "Blue Ice" => Some(Item::BlueIce),
            "Conduit" => Some(Item::Conduit),
            "Polished Granite Stairs" => Some(Item::PolishedGraniteStairs),
            "Smooth Red Sandstone Stairs" => Some(Item::SmoothRedSandstoneStairs),
            "Mossy Stone Brick Stairs" => Some(Item::MossyStoneBrickStairs),
            "Polished Diorite Stairs" => Some(Item::PolishedDioriteStairs),
            "Mossy Cobblestone Stairs" => Some(Item::MossyCobblestoneStairs),
            "End Stone Brick Stairs" => Some(Item::EndStoneBrickStairs),
            "Stone Stairs" => Some(Item::StoneStairs),
            "Smooth Sandstone Stairs" => Some(Item::SmoothSandstoneStairs),
            "Smooth Quartz Stairs" => Some(Item::SmoothQuartzStairs),
            "Granite Stairs" => Some(Item::GraniteStairs),
            "Andesite Stairs" => Some(Item::AndesiteStairs),
            "Red Nether Brick Stairs" => Some(Item::RedNetherBrickStairs),
            "Polished Andesite Stairs" => Some(Item::PolishedAndesiteStairs),
            "Diorite Stairs" => Some(Item::DioriteStairs),
            "Polished Granite Slab" => Some(Item::PolishedGraniteSlab),
            "Smooth Red Sandstone Slab" => Some(Item::SmoothRedSandstoneSlab),
            "Mossy Stone Brick Slab" => Some(Item::MossyStoneBrickSlab),
            "Polished Diorite Slab" => Some(Item::PolishedDioriteSlab),
            "Mossy Cobblestone Slab" => Some(Item::MossyCobblestoneSlab),
            "End Stone Brick Slab" => Some(Item::EndStoneBrickSlab),
            "Smooth Sandstone Slab" => Some(Item::SmoothSandstoneSlab),
            "Smooth Quartz Slab" => Some(Item::SmoothQuartzSlab),
            "Granite Slab" => Some(Item::GraniteSlab),
            "Andesite Slab" => Some(Item::AndesiteSlab),
            "Red Nether Brick Slab" => Some(Item::RedNetherBrickSlab),
            "Polished Andesite Slab" => Some(Item::PolishedAndesiteSlab),
            "Diorite Slab" => Some(Item::DioriteSlab),
            "Scaffolding" => Some(Item::Scaffolding),
            "Iron Door" => Some(Item::IronDoor),
            "Oak Door" => Some(Item::OakDoor),
            "Spruce Door" => Some(Item::SpruceDoor),
            "Birch Door" => Some(Item::BirchDoor),
            "Jungle Door" => Some(Item::JungleDoor),
            "Acacia Door" => Some(Item::AcaciaDoor),
            "Dark Oak Door" => Some(Item::DarkOakDoor),
            "Crimson Door" => Some(Item::CrimsonDoor),
            "Warped Door" => Some(Item::WarpedDoor),
            "Redstone Repeater" => Some(Item::Repeater),
            "Redstone Comparator" => Some(Item::Comparator),
            "Structure Block" => Some(Item::StructureBlock),
            "Jigsaw Block" => Some(Item::Jigsaw),
            "Turtle Shell" => Some(Item::TurtleHelmet),
            "Scute" => Some(Item::Scute),
            "Flint and Steel" => Some(Item::FlintAndSteel),
            "Apple" => Some(Item::Apple),
            "Bow" => Some(Item::Bow),
            "Arrow" => Some(Item::Arrow),
            "Coal" => Some(Item::Coal),
            ...
            "Gold Ingot" => Some(Item::GoldIngot),
            "Netherite Ingot" => Some(Item::NetheriteIngot),
            "Netherite Scrap" => Some(Item::NetheriteScrap),
            "Wooden Sword" => Some(Item::WoodenSword),
            "Wooden Shovel" => Some(Item::WoodenShovel),
            "Wooden Pickaxe" => Some(Item::WoodenPickaxe),
            "Wooden Axe" => Some(Item::WoodenAxe),
            "Wooden Hoe" => Some(Item::WoodenHoe),
            "Stone Sword" => Some(Item::StoneSword),
            "Stone Shovel" => Some(Item::StoneShovel),
            "Stone Pickaxe" => Some(Item::StonePickaxe),
            "Stone Axe" => Some(Item::StoneAxe),
            "Stone Hoe" => Some(Item::StoneHoe),
            "Golden Sword" => Some(Item::GoldenSword),
            "Golden Shovel" => Some(Item::GoldenShovel),
            "Golden Pickaxe" => Some(Item::GoldenPickaxe),
            "Golden Axe" => Some(Item::GoldenAxe),
            "Golden Hoe" => Some(Item::GoldenHoe),
            "Iron Sword" => Some(Item::IronSword),
            "Iron Shovel" => Some(Item::IronShovel),
            "Iron Pickaxe" => Some(Item::IronPickaxe),
            "Iron Axe" => Some(Item::IronAxe),
            "Iron Hoe" => Some(Item::IronHoe),
            "Diamond Sword" => Some(Item::DiamondSword),
            "Diamond Shovel" => Some(Item::DiamondShovel),
            "Diamond Pickaxe" => Some(Item::DiamondPickaxe),
            "Diamond Axe" => Some(Item::DiamondAxe),
            "Diamond Hoe" => Some(Item::DiamondHoe),
            "Netherite Sword" => Some(Item::NetheriteSword),
            "Netherite Shovel" => Some(Item::NetheriteShovel),
            "Netherite Pickaxe" => Some(Item::NetheritePickaxe),
            "Netherite Axe" => Some(Item::NetheriteAxe),
            "Netherite Hoe" => Some(Item::NetheriteHoe),
            "Stick" => Some(Item::Stick),
            "Bowl" => Some(Item::Bowl),
            "Mushroom Stew" => Some(Item::MushroomStew),
            "String" => Some(Item::String),
            "Feather" => Some(Item::Feather),
            "Gunpowder" => Some(Item::Gunpowder),
            "Wheat Seeds" => Some(Item::WheatSeeds),
            "Wheat" => Some(Item::Wheat),
            "Bread" => Some(Item::Bread),
            "Leather Cap" => Some(Item::LeatherHelmet),
            "Leather Tunic" => Some(Item::LeatherChestplate),
            "Leather Pants" => Some(Item::LeatherLeggings),
            "Leather Boots" => Some(Item::LeatherBoots),
            "Chainmail Helmet" => Some(Item::ChainmailHelmet),
            "Chainmail Chestplate" => Some(Item::ChainmailChestplate),
            "Chainmail Leggings" => Some(Item::ChainmailLeggings),
            "Chainmail Boots" => Some(Item::ChainmailBoots),
            "Iron Helmet" => Some(Item::IronHelmet),
            "Iron Chestplate" => Some(Item::IronChestplate),
            "Iron Leggings" => Some(Item::IronLeggings),
            "Iron Boots" => Some(Item::IronBoots),
            "Diamond Helmet" => Some(Item::DiamondHelmet),
            "Diamond Chestplate" => Some(Item::DiamondChestplate),
            "Diamond Leggings" => Some(Item::DiamondLeggings),
            "Diamond Boots" => Some(Item::DiamondBoots),
            "Golden Helmet" => Some(Item::GoldenHelmet),
            "Golden Chestplate" => Some(Item::GoldenChestplate),
            "Golden Leggings" => Some(Item::GoldenLeggings),
            "Golden Boots" => Some(Item::GoldenBoots),
            "Netherite Helmet" => Some(Item::NetheriteHelmet),
            "Netherite Chestplate" => Some(Item::NetheriteChestplate),
            "Netherite Leggings" => Some(Item::NetheriteLeggings),
            "Netherite Boots" => Some(Item::NetheriteBoots),
            "Flint" => Some(Item::Flint),
            "Raw Porkchop" => Some(Item::Porkchop),
            "Cooked Porkchop" => Some(Item::CookedPorkchop),
            "Painting" => Some(Item::Painting),
            "Golden Apple" => Some(Item::GoldenApple),
            "Enchanted Golden Apple" => Some(Item::EnchantedGoldenApple),
            "Oak Sign" => Some(Item::OakSign),
            "Spruce Sign" => Some(Item::SpruceSign),
            "Birch Sign" => Some(Item::BirchSign),
            "Jungle Sign" => Some(Item::JungleSign),
            "Acacia Sign" => Some(Item::AcaciaSign),
            "Dark Oak Sign" => Some(Item::DarkOakSign),
            "Crimson Sign" => Some(Item::CrimsonSign),
            "Warped Sign" => Some(Item::WarpedSign),
            "Bucket" => Some(Item::Bucket),
            "Water Bucket" => Some(Item::WaterBucket),
            "Lava Bucket" => Some(Item::LavaBucket),
            "Minecart" => Some(Item::Minecart),
            "Saddle" => Some(Item::Saddle),
            "Redstone Dust" => Some(Item::Redstone),
            "Snowball" => Some(Item::Snowball),
            "Oak Boat" => Some(Item::OakBoat),
            "Leather" => Some(Item::Leather),
            "Milk Bucket" => Some(Item::MilkBucket),
            "Bucket of Pufferfish" => Some(Item::PufferfishBucket),
            "Bucket of Salmon" => Some(Item::SalmonBucket),
            "Bucket of Cod" => Some(Item::CodBucket),
            "Bucket of Tropical Fish" => Some(Item::TropicalFishBucket),
            "Brick" => Some(Item::Brick),
            "Clay Ball" => Some(Item::ClayBall),
            "Dried Kelp Block" => Some(Item::DriedKelpBlock),
            "Paper" => Some(Item::Paper),
            "Book" => Some(Item::Book),
            "Slimeball" => Some(Item::SlimeBall),
            "Minecart with Chest" => Some(Item::ChestMinecart),
            "Minecart with Furnace" => Some(Item::FurnaceMinecart),
            "Egg" => Some(Item::Egg),
            "Compass" => Some(Item::Compass),
            "Fishing Rod" => Some(Item::FishingRod),
            "Clock" => Some(Item::Clock),
            "Glowstone Dust" => Some(Item::GlowstoneDust),
            "Raw Cod" => Some(Item::Cod),
            "Raw Salmon" => Some(Item::Salmon),
            "Tropical Fish" => Some(Item::TropicalFish),
            "Pufferfish" => Some(Item::Pufferfish),
            "Cooked Cod" => Some(Item::CookedCod),
            "Cooked Salmon" => Some(Item::CookedSalmon),
            "Ink Sac" => Some(Item::InkSac),
            "Cocoa Beans" => Some(Item::CocoaBeans),
            "Lapis Lazuli" => Some(Item::LapisLazuli),
            "White Dye" => Some(Item::WhiteDye),
            "Orange Dye" => Some(Item::OrangeDye),
            "Magenta Dye" => Some(Item::MagentaDye),
            "Light Blue Dye" => Some(Item::LightBlueDye),
            "Yellow Dye" => Some(Item::YellowDye),
            "Lime Dye" => Some(Item::LimeDye),
            "Pink Dye" => Some(Item::PinkDye),
            "Gray Dye" => Some(Item::GrayDye),
            "Light Gray Dye" => Some(Item::LightGrayDye),
            "Cyan Dye" => Some(Item::CyanDye),
            "Purple Dye" => Some(Item::PurpleDye),
            "Blue Dye" => Some(Item::BlueDye),
            "Brown Dye" => Some(Item::BrownDye),
            "Green Dye" => Some(Item::GreenDye),
            "Red Dye" => Some(Item::RedDye),
            "Black Dye" => Some(Item::BlackDye),
            "Bone Meal" => Some(Item::BoneMeal),
            "Bone" => Some(Item::Bone),
            "Sugar" => Some(Item::Sugar),
            "Cake" => Some(Item::Cake),
            "White Bed" => Some(Item::WhiteBed),
            "Orange Bed" => Some(Item::OrangeBed),
            "Magenta Bed" => Some(Item::MagentaBed),
            "Light Blue Bed" => Some(Item::LightBlueBed),
            "Yellow Bed" => Some(Item::YellowBed),
            "Lime Bed" => Some(Item::LimeBed),
            "Pink Bed" => Some(Item::PinkBed),
            "Gray Bed" => Some(Item::GrayBed),
            "Light Gray Bed" => Some(Item::LightGrayBed),
            "Cyan Bed" => Some(Item::CyanBed),
            "Purple Bed" => Some(Item::PurpleBed),
            "Blue Bed" => Some(Item::BlueBed),
            "Brown Bed" => Some(Item::BrownBed),
            "Green Bed" => Some(Item::GreenBed),
            "Red Bed" => Some(Item::RedBed),
            "Black Bed" => Some(Item::BlackBed),
            "Cookie" => Some(Item::Cookie),
            "Map" => Some(Item::FilledMap),
            "Shears" => Some(Item::Shears),
            "Melon Slice" => Some(Item::MelonSlice),
            "Dried Kelp" => Some(Item::DriedKelp),
            "Pumpkin Seeds" => Some(Item::PumpkinSeeds),
            "Melon Seeds" => Some(Item::MelonSeeds),
            "Raw Beef" => Some(Item::Beef),
            "Steak" => Some(Item::CookedBeef),
            "Raw Chicken" => Some(Item::Chicken),
            "Cooked Chicken" => Some(Item::CookedChicken),
            "Rotten Flesh" => Some(Item::RottenFlesh),
            "Ender Pearl" => Some(Item::EnderPearl),
            "Blaze Rod" => Some(Item::BlazeRod),
            "Ghast Tear" => Some(Item::GhastTear),
            "Gold Nugget" => Some(Item::GoldNugget),
            "Nether Wart" => Some(Item::NetherWart),
            "Potion" => Some(Item::Potion),
            "Glass Bottle" => Some(Item::GlassBottle),
            "Spider Eye" => Some(Item::SpiderEye),
            "Fermented Spider Eye" => Some(Item::FermentedSpiderEye),
            "Blaze Powder" => Some(Item::BlazePowder),
            "Magma Cream" => Some(Item::MagmaCream),
            "Brewing Stand" => Some(Item::BrewingStand),
            "Cauldron" => Some(Item::Cauldron),
            "Eye of Ender" => Some(Item::EnderEye),
            "Glistering Melon Slice" => Some(Item::GlisteringMelonSlice),
            "Bat Spawn Egg" => Some(Item::BatSpawnEgg),
            "Bee Spawn Egg" => Some(Item::BeeSpawnEgg),
            "Blaze Spawn Egg" => Some(Item::BlazeSpawnEgg),
            "Cat Spawn Egg" => Some(Item::CatSpawnEgg),
            "Cave Spider Spawn Egg" => Some(Item::CaveSpiderSpawnEgg),
            "Chicken Spawn Egg" => Some(Item::ChickenSpawnEgg),
            "Cod Spawn Egg" => Some(Item::CodSpawnEgg),
            "Cow Spawn Egg" => Some(Item::CowSpawnEgg),
            "Creeper Spawn Egg" => Some(Item::CreeperSpawnEgg),
            "Dolphin Spawn Egg" => Some(Item::DolphinSpawnEgg),
            "Donkey Spawn Egg" => Some(Item::DonkeySpawnEgg),
            "Drowned Spawn Egg" => Some(Item::DrownedSpawnEgg),
            "Elder Guardian Spawn Egg" => Some(Item::ElderGuardianSpawnEgg),
            "Enderman Spawn Egg" => Some(Item::EndermanSpawnEgg),
            "Endermite Spawn Egg" => Some(Item::EndermiteSpawnEgg),
            "Evoker Spawn Egg" => Some(Item::EvokerSpawnEgg),
            "Fox Spawn Egg" => Some(Item::FoxSpawnEgg),
            "Ghast Spawn Egg" => Some(Item::GhastSpawnEgg),
            "Guardian Spawn Egg" => Some(Item::GuardianSpawnEgg),
            "Hoglin Spawn Egg" => Some(Item::HoglinSpawnEgg),
            "Horse Spawn Egg" => Some(Item::HorseSpawnEgg),
            "Husk Spawn Egg" => Some(Item::HuskSpawnEgg),
            "Llama Spawn Egg" => Some(Item::LlamaSpawnEgg),
            "Magma Cube Spawn Egg" => Some(Item::MagmaCubeSpawnEgg),
            "Mooshroom Spawn Egg" => Some(Item::MooshroomSpawnEgg),
            "Mule Spawn Egg" => Some(Item::MuleSpawnEgg),
            "Ocelot Spawn Egg" => Some(Item::OcelotSpawnEgg),
            "Panda Spawn Egg" => Some(Item::PandaSpawnEgg),
            "Parrot Spawn Egg" => Some(Item::ParrotSpawnEgg),
            "Phantom Spawn Egg" => Some(Item::PhantomSpawnEgg),
            "Pig Spawn Egg" => Some(Item::PigSpawnEgg),
            "Piglin Spawn Egg" => Some(Item::PiglinSpawnEgg),
            "Piglin Brute Spawn Egg" => Some(Item::PiglinBruteSpawnEgg),
            "Pillager Spawn Egg" => Some(Item::PillagerSpawnEgg),
            "Polar Bear Spawn Egg" => Some(Item::PolarBearSpawnEgg),
            "Pufferfish Spawn Egg" => Some(Item::PufferfishSpawnEgg),
            "Rabbit Spawn Egg" => Some(Item::RabbitSpawnEgg),
            "Ravager Spawn Egg" => Some(Item::RavagerSpawnEgg),
            "Salmon Spawn Egg" => Some(Item::SalmonSpawnEgg),
            "Sheep Spawn Egg" => Some(Item::SheepSpawnEgg),
            "Shulker Spawn Egg" => Some(Item::ShulkerSpawnEgg),
            "Silverfish Spawn Egg" => Some(Item::SilverfishSpawnEgg),
            "Skeleton Spawn Egg" => Some(Item::SkeletonSpawnEgg),
            "Skeleton Horse Spawn Egg" => Some(Item::SkeletonHorseSpawnEgg),
            "Slime Spawn Egg" => Some(Item::SlimeSpawnEgg),
            "Spider Spawn Egg" => Some(Item::SpiderSpawnEgg),
            "Squid Spawn Egg" => Some(Item::SquidSpawnEgg),
            "Stray Spawn Egg" => Some(Item::StraySpawnEgg),
            "Strider Spawn Egg" => Some(Item::StriderSpawnEgg),
            "Trader Llama Spawn Egg" => Some(Item::TraderLlamaSpawnEgg),
            "Tropical Fish Spawn Egg" => Some(Item::TropicalFishSpawnEgg),
            "Turtle Spawn Egg" => Some(Item::TurtleSpawnEgg),
            "Vex Spawn Egg" => Some(Item::VexSpawnEgg),
            "Villager Spawn Egg" => Some(Item::VillagerSpawnEgg),
            "Vindicator Spawn Egg" => Some(Item::VindicatorSpawnEgg),
            "Wandering Trader Spawn Egg" => Some(Item::WanderingTraderSpawnEgg),
            "Witch Spawn Egg" => Some(Item::WitchSpawnEgg),
            "Wither Skeleton Spawn Egg" => Some(Item::WitherSkeletonSpawnEgg),
            "Wolf Spawn Egg" => Some(Item::WolfSpawnEgg),
            "Zoglin Spawn Egg" => Some(Item::ZoglinSpawnEgg),
            "Zombie Spawn Egg" => Some(Item::ZombieSpawnEgg),
            "Zombie Horse Spawn Egg" => Some(Item::ZombieHorseSpawnEgg),
            "Zombie Villager Spawn Egg" => Some(Item::ZombieVillagerSpawnEgg),
            "Zombified Piglin Spawn Egg" => Some(Item::ZombifiedPiglinSpawnEgg),
            "Bottle o' Enchanting" => Some(Item::ExperienceBottle),
            "Fire Charge" => Some(Item::FireCharge),
            "Book and Quill" => Some(Item::WritableBook),
            "Written Book" => Some(Item::WrittenBook),
            "Emerald" => Some(Item::Emerald),
            "Item Frame" => Some(Item::ItemFrame),
            "Flower Pot" => Some(Item::FlowerPot),
            "Carrot" => Some(Item::Carrot),
            "Potato" => Some(Item::Potato),
            "Baked Potato" => Some(Item::BakedPotato),
            "Poisonous Potato" => Some(Item::PoisonousPotato),
            "Empty Map" => Some(Item::Map),
            "Golden Carrot" => Some(Item::GoldenCarrot),
            "Skeleton Skull" => Some(Item::SkeletonSkull),
            "Wither Skeleton Skull" => Some(Item::WitherSkeletonSkull),
            "Player Head" => Some(Item::PlayerHead),
            "Zombie Head" => Some(Item::ZombieHead),
            "Creeper Head" => Some(Item::CreeperHead),
            "Dragon Head" => Some(Item::DragonHead),
            "Carrot on a Stick" => Some(Item::CarrotOnAStick),
            "Warped Fungus on a Stick" => Some(Item::WarpedFungusOnAStick),
            "Nether Star" => Some(Item::NetherStar),
            "Pumpkin Pie" => Some(Item::PumpkinPie),
            "Firework Rocket" => Some(Item::FireworkRocket),
            "Firework Star" => Some(Item::FireworkStar),
            "Enchanted Book" => Some(Item::EnchantedBook),
            "Nether Brick" => Some(Item::NetherBrick),
            "Nether Quartz" => Some(Item::Quartz),
            "Minecart with TNT" => Some(Item::TntMinecart),
            "Minecart with Hopper" => Some(Item::HopperMinecart),
            "Prismarine Shard" => Some(Item::PrismarineShard),
            "Prismarine Crystals" => Some(Item::PrismarineCrystals),
            "Raw Rabbit" => Some(Item::Rabbit),
            "Cooked Rabbit" => Some(Item::CookedRabbit),
            "Rabbit Stew" => Some(Item::RabbitStew),
            "Rabbit's Foot" => Some(Item::RabbitFoot),
            "Rabbit Hide" => Some(Item::RabbitHide),
            "Armor Stand" => Some(Item::ArmorStand),
            "Iron Horse Armor" => Some(Item::IronHorseArmor),
            "Golden Horse Armor" => Some(Item::GoldenHorseArmor),
            "Diamond Horse Armor" => Some(Item::DiamondHorseArmor),
            "Leather Horse Armor" => Some(Item::LeatherHorseArmor),
            "Lead" => Some(Item::Lead),
            "Name Tag" => Some(Item::NameTag),
            "Minecart with Command Block" => Some(Item::CommandBlockMinecart),
            "Raw Mutton" => Some(Item::Mutton),
            "Cooked Mutton" => Some(Item::CookedMutton),
            "White Banner" => Some(Item::WhiteBanner),
            "Orange Banner" => Some(Item::OrangeBanner),
            "Magenta Banner" => Some(Item::MagentaBanner),
            "Light Blue Banner" => Some(Item::LightBlueBanner),
            "Yellow Banner" => Some(Item::YellowBanner),
            "Lime Banner" => Some(Item::LimeBanner),
            "Pink Banner" => Some(Item::PinkBanner),
            "Gray Banner" => Some(Item::GrayBanner),
            "Light Gray Banner" => Some(Item::LightGrayBanner),
            "Cyan Banner" => Some(Item::CyanBanner),
            "Purple Banner" => Some(Item::PurpleBanner),
            "Blue Banner" => Some(Item::BlueBanner),
            "Brown Banner" => Some(Item::BrownBanner),
            "Green Banner" => Some(Item::GreenBanner),
            "Red Banner" => Some(Item::RedBanner),
            "Black Banner" => Some(Item::BlackBanner),
            "End Crystal" => Some(Item::EndCrystal),
            "Chorus Fruit" => Some(Item::ChorusFruit),
            "Popped Chorus Fruit" => Some(Item::PoppedChorusFruit),
            "Beetroot" => Some(Item::Beetroot),
            "Beetroot Seeds" => Some(Item::BeetrootSeeds),
            "Beetroot Soup" => Some(Item::BeetrootSoup),
            "Dragon's Breath" => Some(Item::DragonBreath),
            "Splash Potion" => Some(Item::SplashPotion),
            "Spectral Arrow" => Some(Item::SpectralArrow),
            "Tipped Arrow" => Some(Item::TippedArrow),
            "Lingering Potion" => Some(Item::LingeringPotion),
            "Shield" => Some(Item::Shield),
            "Elytra" => Some(Item::Elytra),
            "Spruce Boat" => Some(Item::SpruceBoat),
            "Birch Boat" => Some(Item::BirchBoat),
            "Jungle Boat" => Some(Item::JungleBoat),
            "Acacia Boat" => Some(Item::AcaciaBoat),
            "Dark Oak Boat" => Some(Item::DarkOakBoat),
            "Totem of Undying" => Some(Item::TotemOfUndying),
            "Shulker Shell" => Some(Item::ShulkerShell),
            "Iron Nugget" => Some(Item::IronNugget),
            "Knowledge Book" => Some(Item::KnowledgeBook),
            "Debug Stick" => Some(Item::DebugStick),
            "13 Disc" => Some(Item::MusicDisc13),
            "Cat Disc" => Some(Item::MusicDiscCat),
            "Blocks Disc" => Some(Item::MusicDiscBlocks),
            "Chirp Disc" => Some(Item::MusicDiscChirp),
            "Far Disc" => Some(Item::MusicDiscFar),
            "Mall Disc" => Some(Item::MusicDiscMall),
            "Mellohi Disc" => Some(Item::MusicDiscMellohi),
            "Stal Disc" => Some(Item::MusicDiscStal),
            "Strad Disc" => Some(Item::MusicDiscStrad),
            "Ward Disc" => Some(Item::MusicDiscWard),
            "11 Disc" => Some(Item::MusicDisc11),
            "Wait Disc" => Some(Item::MusicDiscWait),
            "Music Disc" => Some(Item::MusicDiscPigstep),
            "Trident" => Some(Item::Trident),
            "Phantom Membrane" => Some(Item::PhantomMembrane),
            "Nautilus Shell" => Some(Item::NautilusShell),
            "Heart of the Sea" => Some(Item::HeartOfTheSea),
            "Crossbow" => Some(Item::Crossbow),
            "Suspicious Stew" => Some(Item::SuspiciousStew),
            "Loom" => Some(Item::Loom),
            "Banner Pattern" => Some(Item::FlowerBannerPattern),
            "Banner Pattern" => Some(Item::CreeperBannerPattern),
            "Banner Pattern" => Some(Item::SkullBannerPattern),
            "Banner Pattern" => Some(Item::MojangBannerPattern),
            "Banner Pattern" => Some(Item::GlobeBannerPattern),
            "Banner Pattern" => Some(Item::PiglinBannerPattern),
            "Composter" => Some(Item::Composter),
            "Barrel" => Some(Item::Barrel),
            "Smoker" => Some(Item::Smoker),
            "Blast Furnace" => Some(Item::BlastFurnace),
            "Cartography Table" => Some(Item::CartographyTable),
            "Fletching Table" => Some(Item::FletchingTable),
            "Grindstone" => Some(Item::Grindstone),
            "Lectern" => Some(Item::Lectern),
            "Smithing Table" => Some(Item::SmithingTable),
            "Stonecutter" => Some(Item::Stonecutter),
            "Bell" => Some(Item::Bell),
            "Lantern" => Some(Item::Lantern),
            "Soul Lantern" => Some(Item::SoulLantern),
            "Sweet Berries" => Some(Item::SweetBerries),
            "Campfire" => Some(Item::Campfire),
            "Soul Campfire" => Some(Item::SoulCampfire),
            "Shroomlight" => Some(Item::Shroomlight),
            "Honeycomb" => Some(Item::Honeycomb),
            "Bee Nest" => Some(Item::BeeNest),
            "Beehive" => Some(Item::Beehive),
            "Honey Bottle" => Some(Item::HoneyBottle),
            "Honey Block" => Some(Item::HoneyBlock),
            "Honeycomb Block" => Some(Item::HoneycombBlock),
            "Lodestone" => Some(Item::Lodestone),
            "Block of Netherite" => Some(Item::NetheriteBlock),
            "Ancient Debris" => Some(Item::AncientDebris),
            "Target" => Some(Item::Target),
            "Crying Obsidian" => Some(Item::CryingObsidian),
            "Blackstone" => Some(Item::Blackstone),
            "Blackstone Slab" => Some(Item::BlackstoneSlab),
            "Blackstone Stairs" => Some(Item::BlackstoneStairs),
            "Gilded Blackstone" => Some(Item::GildedBlackstone),
            "Polished Blackstone" => Some(Item::PolishedBlackstone),
            "Polished Blackstone Slab" => Some(Item::PolishedBlackstoneSlab),
            "Polished Blackstone Stairs" => Some(Item::PolishedBlackstoneStairs),
            "Chiseled Polished Blackstone" => Some(Item::ChiseledPolishedBlackstone),
            "Polished Blackstone Bricks" => Some(Item::PolishedBlackstoneBricks),
            "Polished Blackstone Brick Slab" => Some(Item::PolishedBlackstoneBrickSlab),
            "Polished Blackstone Brick Stairs" => Some(Item::PolishedBlackstoneBrickStairs),
            "Cracked Polished Blackstone Bricks" => Some(Item::CrackedPolishedBlackstoneBricks),
            "Respawn Anchor" => Some(Item::RespawnAnchor),
            _ => None,
        }
    }
}
